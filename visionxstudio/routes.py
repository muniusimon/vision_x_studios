...
from visionxstudio import app, db, bcrypt
from visionxstudio.forms import RegistrationForm, LoginForm, UpdateAccountForm, ProjectForm
from visionxstudio.models import User, Post, Project
...
def new_project():
    form = ProjectForm()
    if form.validate_on_submit():
        project = Project(name=form.name.data, description=form.description.data, author=current_user)
...
def projects():
    ...
    return render_template('projects.html', title='Your Projects', projects=projects)